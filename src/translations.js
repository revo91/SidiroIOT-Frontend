    ...
    translation: {
      ...
      DevicesSelectionPage: {
        ...
        Properties: {
          ...
          tickNormalization: "Time stamp normalization",
          noNormalizationText: "No normalization",
          setTickAsBeginOfIntervalText: "Time of inter. begin",
          setTickAsEndOfIntervalText: "Time of inter. end",
          sendOnlyIfTickFitsSendingIntervalText: "Send only if the same",
          boarded: "Boarded",
          ...
          MaxCalculator: "Max values",
          MinCalculator: "Min values",
          ...
          mqttName: "MQTT name",
          clientId: "Client ID",
          checkStateInterval: "Check state interval [s]",
          model: "Model",
          revision: "Revision",
      ...
      AccountPage: {
        ...
        PasswordHelperError8characters:
      ...
      Snackbar: {
        ...
        UnsuccessfulFileUpload403:
          "Only admin type accounts have permission to send configuration file",
      ...
      IPConfigDialog: {
        ...
        DisconnectionWarningDhcpFalse:
          "Since you're connected to this IP address, you may lose connection with device and application after changing these settings. We'll try to forward you to new one automatically.",
        DisconnectionWarningDhcpTrue:
          "Since you're connected to this IP address, you may lose connection with device and application after changing these settings. Your router will allocate IP address automatically, which will then be necessary to enter in browser's address bar.",
    ...
    translation: {
      ...
      DevicesSelectionPage: {
        ...
        Properties: {
          ...
          tickNormalization: "Normalizacja stempla czasowego",
          noNormalizationText: "Brak normalizacji",
          setTickAsBeginOfIntervalText: "Czas z początku inter.",
          setTickAsEndOfIntervalText: "Czas z końca inter.",
          sendOnlyIfTickFitsSendingIntervalText: "Wyslij tylko gdy pasuje",
          boarded: "Boarded",
          ...
          MaxCalculator: "Wartości maksymalne",
          MinCalculator: "Wartości minimalne",
          ...
          mqttName: "Nazwa MQTT",
          clientId: "ID klienta",
          checkStateInterval: "Interwał sprawdzania stanu [s]",
          model: "Model",
          revision: "Rewizja",
      ...
      Snackbar: {
        ...
        UnsuccessfulFileUpload403:
          "Tylko konta admina mają uprawnienia do wysyłania pliku konfiguracyjnego",
        ...
        UnsuccessfulIPConfig:
          "Wprowadzone dane są nieprawidłowe. Spróbuj ponownie.",
      },
      ConfirmDeleteUserDialog: {
      ...
      IPConfigDialog: {
        ...
        DisconnectionWarningDhcpFalse:
          "Ponieważ jesteś aktualnie połączony z tym adresem IP, po zmianie tych ustawień możesz stracić połączenie z urządzeniem. Spróbujemy Cię automatycznie przekierować na nowy adres IP.",
        DisconnectionWarningDhcpTrue:
          "Ponieważ jesteś aktualnie połączony z tym adresem IP, po zmianie tych ustawień możesz stracić połączenie z urządzeniem. Twój router automatycznie przydzieli nowy adres, który należy wprowadzić w pasek adresu przeglądarki by wznowić połączenie.",
